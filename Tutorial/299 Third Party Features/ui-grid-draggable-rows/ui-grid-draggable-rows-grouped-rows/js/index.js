var app = angular.module('app', ['ui.bootstrap', 'ui.grid', 'ui.grid.draggable-rows', 'ui.grid.grouping']);
...
app.controller('MainCtrl', function($scope, $timeout) {
  ...
  $scope.gridOptions = {
    ...
    onRegisterApi: function( gridApi ) {
        ...
        $timeout(function() {
          gridApi.grouping.groupColumn('gender'); 
        });
         
        gridApi.draggableRows.on.beforeRowMove(
            $scope,
            function(from, to, data) {
              data[from].gender = data[to].gender;
            }
        );
    }
  };
